...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 27, 2022 at 10:42 AM
...
(1, 'button', '1400', 'kg', '12.0'),
(2, 'zip', '2800', 'kg', '28.0'),
(3, 'fabrics', '5000', 'kg', '10.0'),
(4, 'thread', '1000', 'kg', '23.0');
...
--
-- Dumping data for table `order_material_com`
--

INSERT INTO `order_material_com` (`ord_id`, `material_id`, `material_qty`, `price`) VALUES
(4, 1, '1.0', '1400.0'),
(4, 3, '3.0', '15000.0'),
(4, 4, '1.0', '1000.0');
...
--
-- Dumping data for table `product_materials_com`
--

INSERT INTO `product_materials_com` (`pdt_id`, `material_id`, `material_qty`) VALUES
(1, 1, '0.1'),
(1, 3, '0.3'),
(1, 4, '0.1');
...
(2, 'hemal', '222', '456', 'vdfvfvv', 'Sales'),
(3, 'roshan', '222', '456', 'djvjsv', 'Marketing'),
(4, 'chamodi', '222', '456', 'dfvmkldfv', 'Warehouse'),
(5, 'minoli', '222', '456', 'ksmfdkmv', 'Production');
